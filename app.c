...
void sl_bt_on_event(sl_bt_msg_t *evt) {
  ...
  switch (SL_BT_MSG_ID(evt->header)) {
    ...
    case sl_bt_evt_connection_opened_id:
      ...
      sc = sl_bt_connection_set_remote_power_reporting(evt->data.evt_connection_opened.connection, sl_bt_connection_power_reporting_enable);
      app_assert_status(sc);
...
void sl_bt_ht_temperature_measurement_indication_changed_cb(uint8_t connection, sl_bt_gatt_client_config_flag_t client_config) {
  ...
  if (sl_bt_gatt_disable != client_config) {
    ...
    sc = sl_simple_timer_start(&app_periodic_timer, SL_BT_HT_MEASUREMENT_INTERVAL_SEC * 1000, app_periodic_timer_cb, NULL, true);
    app_assert_status(sc);
...
/*********************************************************************************************************************************//**
 * Hello Something
 * Not really sure this was just here.
 ************************************************************************************************************************************/
