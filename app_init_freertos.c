...
void app_init_task(void *p_arg) {
  ...
  app_log_info("health thermometer initialized\n");
...
#if (APP_INIT_TASK_STATIC == 1)
	xTaskCreateStatic(app_init_task, APP_INIT_TASK_NAME, configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY,
					  app_init_task_stack, &app_init_task_handle);
#else 																	/* configSUPPORT_STATIC_ALLOCATION						*/
  xTaskCreate(app_init_task, APP_INIT_TASK_NAME, configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY, &app_init_task_handle);
#endif 																	/* configSUPPORT_STATIC_ALLOCATION						*/
